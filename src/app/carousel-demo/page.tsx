        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="jewelry-card p-6 text-center">
              ...
              <p className="body-text">Smooth navigation with custom styled arrow buttons</p>
            </div>
            ...
            <div className="jewelry-card p-6 text-center">
              ...
              <p className="body-text">Interactive dot navigation showing current slide position</p>
            </div>
            ...
            <div className="jewelry-card p-6 text-center">
              ...
              <p className="body-text">Fully responsive and optimized for all device sizes</p>
            </div>
          </div>
        </div>
      </div>
