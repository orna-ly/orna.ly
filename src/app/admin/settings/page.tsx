      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input value={settings['store:name'] || ''} onChange={e=>setSettings(s=>({ ...s, ['store:name']: e.target.value }))} />
          </div>
          <div>
            <label className="block text-sm mb-1">Currency</label>
            <Input value={settings['store:currency'] || 'LYD'} onChange={e=>setSettings(s=>({ ...s, ['store:currency']: e.target.value }))} />
          ...
          <div>
            ...
            <Input value={settings['store:deliveryRegion'] || 'Libya'} onChange={e=>setSettings(s=>({ ...s, ['store:deliveryRegion']: e.target.value }))} />
          </div>
          <div>
            <label className="block text-sm mb-1">Contact Phone</label>
            <Input value={settings['store:contactPhone'] || ''} onChange={e=>setSettings(s=>({ ...s, ['store:contactPhone']: e.target.value }))} />
          </div>
          <div>
            <label className="block text-sm mb-1">Contact Email</label>
            <Input value={settings['store:contactEmail'] || ''} onChange={e=>setSettings(s=>({ ...s, ['store:contactEmail']: e.target.value }))} />
          </div>
